...
var brake_power: float = 225.0
var max_speed: float = 550.0
var max_reverse_speed: float = 220.0
var rotation_speed: float = 2.0
var friction: float = 40.0
var grip_traction: float = 2.5
var drift_traction: float = 0.85
var grip_angle_threshold: float = 6.0
var max_slip_angle: float = 65.0
var min_steer_turn_factor: float = 0.33
func _ready() -> void:
	pass
...
func _move(delta: float) -> void:
	...
	var longitudinal_t: float = 1.0 if (Input.is_action_pressed("accelerate")) else 0.0
